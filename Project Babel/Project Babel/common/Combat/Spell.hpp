	...
	inline glm::vec2 Operate(Controller *ctrl, ScreenUniformData * u_data, glm::vec2 offset, GLboolean **tiles)
	{
		...
		if (npcscale == 1)
		{
			if ((tiles[rPosition.x][rPosition.y] == 0 || rPosition == initial) && rPosition.x >= 0 && rPosition.y >= 0 && !(rPosition == (glm::ivec2)lpos))
			{
				...
				//else if (direction == RIGHT && tiles[rPosition.x + 1][rPosition.y + 1] == 1)
				//{
				//	this->active = false;
				//	rPosition.x++;
				//	return position;
				//}
				//else if (direction == DOWN && tiles[rPosition.x + 1][rPosition.y + 1] == 1)
				//{
				//	this->active = false;
				...
				//	return position;
				//}
				//else if (direction == UP && tiles[rPosition.x + 1][rPosition.y] == 1)
				//{
				//	this->active = false;
				...
				//	return position;
				//}
				//else if (direction == LEFT && tiles[rPosition.x][rPosition.y + 1] == 1)
				//{
				//	this->active = false;
